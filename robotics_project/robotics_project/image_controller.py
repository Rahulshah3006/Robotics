...
class ImageController(ControllerNode):
    ...
    def __init__(self):
        ...
        self.Image_subscriber = self.create_subscription(CompressedImage, '/camera/image_raw/compressed', self.Imager_reader, 1)
        
        self.image_save_directory = "/home/robotics23/dev_ws/src/thymiroomba/images"

    def Imager_reader(self,im):
        self.get_logger().info(f"I am entering image cache")
    ...
    def saveImage(self):
        filename = os.path.join(self.image_save_directory, "image_demo.jpg")
